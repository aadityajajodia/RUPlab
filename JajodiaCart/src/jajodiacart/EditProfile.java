...
public class EditProfile extends javax.swing.JFrame {
    ...
    UserDetails obj;
    public EditProfile(UserDetails obj) {
        initComponents();
        this.obj=obj;
        jTextField1.setText(obj.name);
        jTextField2.setText(obj.password);
        jTextField3.setText(obj.email);
        jTextField4.setText(obj.address);
    ...
    private void initComponents() {
        ...
        jTextField3.setText("something@gmail.com");

        jLabel4.setText("Address");

        jTextField4.setText("Home Sweet Home");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        obj.address=jTextField4.getText();
